...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Blooddonation " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"blooddonation.com", "31.131.27.190"},
	{"31.131.27.190", "31.131.27.190"},
	{NULL, NULL}
};
...
unsigned int pnSeed[] =
{
    ...
    0x8e2eddb0, 0x09daf150, 0x8a67c7c6, 0x22a9e52e, 0x05cff476, 0xc99b2f4e, 0x0f183b25, 0xd0121013,
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Blooddonation is probably already running."), addrBind.ToString().c_str());
        else
